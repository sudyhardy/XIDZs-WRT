...
rename_firmware() {
    ...
    local search_replace_patterns=(
        ...
        "-sunxi-cortexa53-xunlong_orangepi-pc2-squashfs-sdcard|Orangepi-Pc2-squashfs-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-pc2-ext4-sdcard|Orangepi-Pc2-ext4-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-zero-plus-squashfs-sdcard|Orangepi-Zero-Plus-squashfs-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-zero-plus-ext4-sdcard|Orangepi-Zero-Plus-ext4-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-zero2-squashfs-sdcard|Orangepi-Zero2-squashfs-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-zero2-ext4-sdcard|Orangepi-Zero2-ext4-sdcard"   
        "-sunxi-cortexa53-xunlong_orangepi-zero3-squashfs-sdcard|Orangepi-Zero3-squashfs-sdcard"
        "-sunxi-cortexa53-xunlong_orangepi-zero3-ext4-sdcard|Orangepi-Zero3-ext4-sdcard"
